...
if(empty($_GET['idGroupe']) or empty($_GET['idGroupeFils']))
{
...
$idGroupeFils=htmlspecialchars($_GET['idGroupeFils']);
...
$res=retirerLienFils($idGroupe, $idGroupeFils); //on valide le lien
